          ...
          <div class="w3-grid-template">
               ...
               $count = 0;
                foreach ($rows as $payments){
                    ...
                    Item ordered: $count<br>Paid: RM $paymentpaid<br>Date: $paymentdate<br>
                ...
                $totalpaid = number_format($totalpaid, 2, '.', '');
            echo "</div><br><hr><div class='w3-container w3-left'><h4>Your Orders</h4><p>Name: $user_name Total Paid: RM $totalpaid<p></div>";
               ?>
          </div>
      </div>
